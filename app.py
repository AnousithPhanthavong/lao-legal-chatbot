...
def load_system():
    ...
    # ── ChromaDB: Load or rebuild from embeddings cache ──
    ...
    # Build LAW_KEYWORDS dynamically from all loaded laws
    law_keywords = {}
